    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a href="dashboard.php">Profile Ustad</a>
          </li>
     ...
     <div class="form-group">
        ...
        <div class="form-group">
            <div class="form-label-group">
             <input type="text" name="nip" id="nip" class="form-control" placeholder="nip" value="<?php print $row['nip'];?>"required="required">
                <label for="nip">NIP</label>
            </div>
        </div>
          <div class="form-group">
            <div class="form-label-group">
            <input type="text" name="nama" id="nama" class="form-control" value="<?php print $row['nama'];?>"required="required">
